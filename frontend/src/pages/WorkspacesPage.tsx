          ...
          <div className="rounded-md bg-error-50 dark:bg-error-900/20 p-4 border border-error-200 dark:border-error-800">
            <div className="flex">
              <div className="flex-shrink-0">
                <svg className="h-5 w-5 text-error-400 dark:text-error-500" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="ml-3">
                ...
                <div className="mt-1 text-sm text-error-700 dark:text-error-300">{error}</div>
              </div>
            </div>
          </div>
        )}
