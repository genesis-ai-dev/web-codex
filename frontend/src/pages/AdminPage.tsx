...
const WorkspacesTabContent: React.FC = () => {
  ...
  const [costBreakdownWorkspace, setCostBreakdownWorkspace] = React.useState<any | null>(null);
  ...
  return (
    <>
                ...
                <div className="px-4 py-4 sm:px-6 hover:bg-gray-50 dark:hover:bg-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="ml-4 flex-shrink-0 flex gap-2">
                      <button
                        onClick={() => setCostBreakdownWorkspace(workspace)}
                        className="inline-flex items-center px-3 py-2 border border-blue-300 dark:border-blue-600 shadow-sm text-sm leading-4 font-medium rounded-md text-blue-700 dark:text-blue-400 bg-white dark:bg-gray-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
      ...
      {costBreakdownWorkspace && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            {/* Background overlay */}
            <div
              className="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-75"
              onClick={() => setCostBreakdownWorkspace(null)}
            ></div>
            ...
            <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
              ...
              <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                    Cost Breakdown: {costBreakdownWorkspace.name}
                  </h3>
                  <button
                    onClick={() => setCostBreakdownWorkspace(null)}
              ...
              {/* Content */}
              <div className="bg-gray-50 dark:bg-gray-900 px-4 pt-5 pb-4 sm:p-6">
                <React.Suspense fallback={<div>Loading cost breakdown...</div>}>
                  {(() => {
                    const { WorkspaceCostBreakdown } = require('../components/WorkspaceCostBreakdown');
                    return (
                      <WorkspaceCostBreakdown
                        workspaceId={costBreakdownWorkspace.id}
                        workspaceName={costBreakdownWorkspace.name}
                      />
                    );
                  })()}
                </React.Suspense>
